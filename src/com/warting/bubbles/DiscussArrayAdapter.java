...
public class DiscussArrayAdapter extends ArrayAdapter<OneComment> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		imageViewLeft = (ImageView) row.findViewById(R.id.avatarLeft);
		imageViewRight = (ImageView) row.findViewById(R.id.avatarRight);
		if(coment.left){
			imageViewRight.setImageBitmap(null);
			imageViewLeft.setImageBitmap(coment.image);
		}else{			
			imageViewRight.setImageBitmap(coment.image);
